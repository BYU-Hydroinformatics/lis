...
def home(request):
    ...
    date_select = SelectInput(display_text='Select a Date',
                                  name='date-select',
                                  options=dates_list, )
    context = {"variable_select":variable_select,"date_select":date_select,"first_day":first_day,"slider_max":slider_max,"display_vars":display_vars,"var_metadata":var_metadata,"cbar":cbar}
